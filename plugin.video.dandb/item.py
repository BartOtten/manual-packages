class Item(object):
    ...
    def tostring(self):
        return "title=["+self.title+"], url=["+self.url+"], thumbnail=["+self.thumbnail+"], action=["+self.action+"], folder=["+str(self.folder)+"]"
    ...
    def serialize(self):
        ...
        devuelve = devuelve + self.command + separator
        devuelve = devuelve + self.file_url + separator
        return devuelve
    ...
    def deserialize(self,cadena):
        ...
        self.command = trozos[9]
        self.file_url = trozos[10]
